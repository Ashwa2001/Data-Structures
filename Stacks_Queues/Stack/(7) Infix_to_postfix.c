...
void convert_postfix(char *infix,char*postfix)
{
    ...
    while(infix[i]!='\0')
    {
		...
		//if input precedence of input symbol is greater than
		//stack precedence of top of the stack
	    ...
	    {
			//if input precedence of symbol is equal to stack precednce of top of stack 
	    	//possible when you compare '(' with ')'
        	pop(s,&top); 
    	}
    	i++;
	}
